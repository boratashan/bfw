...
/**
 * Converter for {@link b.contentcollector.adapters.ContentInfo}.
 * NOTE: This class has been automatically generated from the {@link b.contentcollector.adapters.ContentInfo} original class using Vert.x codegen.
 */
      ...
      switch (member.getKey()) {
        case "encodeDecodeType":
          if (member.getValue() instanceof String) {
            obj.setEncodeDecodeType(b.contentcollector.adapters.EncodeDecodeType.valueOf((String)member.getValue()));
          }
          break;
        case "id":
          if (member.getValue() instanceof String) {
