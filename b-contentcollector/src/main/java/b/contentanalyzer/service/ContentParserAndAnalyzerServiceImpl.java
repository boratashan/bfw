...
public class ContentParserAndAnalyzerServiceImpl implements ContentParserAndAnalyzerService {
    private static final String COLLECTION_CONTENTS  = "contents";

    private MongoClient mongoClient;
    private Logger logger;

    public ContentParserAndAnalyzerServiceImpl(MongoClient mongoClient, Logger logger) {
    ...
    public ContentParserAndAnalyzerService parseContent(String contentId, Handler<AsyncResult<Boolean>> resultHandler) {
        Future<JsonObject> readFuture = readContent(contentId);
