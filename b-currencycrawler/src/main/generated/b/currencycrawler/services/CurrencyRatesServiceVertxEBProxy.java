...
public class CurrencyRatesServiceVertxEBProxy implements CurrencyRatesService {
  private Vertx _vertx;
  private String _address;
  private DeliveryOptions _options;
  private boolean closed;

  public CurrencyRatesServiceVertxEBProxy(Vertx vertx, String address) {
    this(vertx, address, null);
  }

  public CurrencyRatesServiceVertxEBProxy(Vertx vertx, String address, DeliveryOptions options) {
    this._vertx = vertx;
  ...
  public  CurrencyRatesService getLatestCurrencyRates(Handler<AsyncResult<JsonObject>> resultHandler){
    ...
    _deliveryOptions.addHeader("action", "getLatestCurrencyRates");
  ...
  public  CurrencyRatesService getCurrencyRates(PaginationRequest paginationOptions, Handler<AsyncResult<List<JsonObject>>> resultHandler){
    ...
    JsonObject _json = new JsonObject();
    _json.put("paginationOptions", paginationOptions == null ? null : paginationOptions.toJson());

    DeliveryOptions _deliveryOptions = (_options != null) ? new DeliveryOptions(_options) : new DeliveryOptions();
    _deliveryOptions.addHeader("action", "getCurrencyRates");
